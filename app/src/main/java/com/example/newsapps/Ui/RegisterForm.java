...
public class RegisterForm extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ed_email = (EditText) findViewById(R.id.ed_email_register);
        ed_password = (EditText) findViewById(R.id.ed_password_register);
        ed_username = findViewById(R.id.ed_username_register);
        ed_nama = findViewById(R.id.ed_nama_register);
        ed_no = findViewById(R.id.ed_no);
        ed_alamat = findViewById(R.id.ed_alamat_register);
        ed_umur = findViewById(R.id.ed_umur_register);
...
//                    Log.d("", "data : " + email + password + username + nama + noTelp + alamat + umur + gender);
    ...
    public void register(String email, String password, String username, String nama, String notelp, String alamat, String umur, String gender) {
        AndroidNetworking.post("https://news-appapi.herokuapp.com/api/register")
